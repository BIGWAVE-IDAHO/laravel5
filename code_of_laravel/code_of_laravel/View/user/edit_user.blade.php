				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="{{url('users/edit')}}" id="form_sample_1" class="form-horizontal" method="post">
								...
								<div class="form-body">
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="first_name" data-required="1" class="form-control" value="{{$user['first_name']}}"/>
										</div>
									</div>
                                    <div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="last_name" data-required="1" class="form-control" value="{{$user['last_name']}}"/>
										</div>
									</div>
									<!--<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input name="email" type="text" class="form-control" data-required="1" value="{{$user['email']}}"/>
										</div>
									</div>-->
									<!--<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<select class="form-control" name="group">
												...
												<option value="{{$group['id']}}" @if($user['ingroup'][0]['id']==$group['id']) selected @endif>{{$group['groupname']}}</option>
												@endforeach
											</select>
										</div>
									</div>
                                    <div class="form-group">
										...
										<div class="col-md-4">
											<input name="is_admin" type="checkbox" value="1" class="form-control" @if($user['ingroup'][0]['pivot']['is_admin']==1) checked @endif />
										</div>
									</div>
