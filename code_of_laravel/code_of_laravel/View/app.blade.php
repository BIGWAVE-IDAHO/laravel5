...
<link id="style_color" href="{{ asset('/public/assets/admin/layout/css/themes/darkblue.css')}}" rel="stylesheet" type="text/css"/>
						...
						<li>
							<ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
								<li>
									...
									<span class="photo">
									<img src="{{ asset('/public/assets/admin/layout3/img/avatar2.jpg')}}" class="img-circle" alt="">
									</span>
									<span class="subject">
									<span class="from">
									Lisa Wong </span>
								...
								<li>
									<a href="inbox.html?a=view">
									<span class="photo">
									<img src="{{ asset('/public/assets/admin/layout3/img/avatar3.jpg')}}" class="img-circle" alt="">
									</span>
									<span class="subject">
									<span class="from">
									Richard Doe </span>
								...
								<li>
									<a href="inbox.html?a=view">
									<span class="photo">
									<img src="{{ asset('/public/assets/admin/layout3/img/avatar1.jpg')}}" class="img-circle" alt="">
									</span>
									<span class="subject">
									<span class="from">
									Bob Nilson </span>
	...
	<div class="page-sidebar-wrapper">
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<li class="start @if(Request::is('home')) {{'active open'}} @endif">
					<a href="{{url('/home')}}">
					<i class="icon-home"></i>
                ...
                @if(Auth::user()->status==5 || Session::get('group_id')!='')
                <li class="@if((Request::is('users/*') || Request::is('users')) &&(!Request::is('users/myaccount'))) {{'active open'}} @endif">
					...
					<ul class="sub-menu">
						...
						<li class="@if(Request::is('users/create')) {{'active open'}} @endif">
                ...
                <li class="@if(Request::is('groups/*') || Request::is('groups')) {{'active open'}} @endif">
					<a href="javascript:void(0);">
					...
					<ul class="sub-menu">
						<li class="@if(Request::is('groups')) {{'active open'}} @endif">
							<a href="{{url('/groups')}}">
							<i class="icon-list"></i>
							Group Listing</a>
						</li>
						<li class="@if(Request::is('groups/create')) {{'active open'}} @endif">
                ...
                @endif
                 <li class="@if(Request::is('numbers/*') || Request::is('numbers')) {{'active open'}} @endif">
					<a href="javascript:void(0)">
					<i class="icon-grid"></i>
					...
					<ul class="sub-menu">
                        <li class="@if(Request::is('numbers')) {{'active open'}} @endif">
							<a href="{{url('/numbers')}}">
							<i class="icon-list"></i>
							Number Listing</a>
						</li>
                        @if(Auth::user()->status!=5)
                        <li class="@if(Request::is('numbers/request')) {{'active open'}} @endif">
							<a href="{{url('/numbers/sendrequest')}}">
							<i class="icon-bar-chart"></i>
							Send Number Request</a>
						</li>
                        @endif
                         @if(Auth::user()->status==5)
						<li class="@if(Request::is('groups')) {{'active open'}} @endif">
							<a href="{{url('/numbers/request')}}">
							<i class="icon-bar-chart"></i>
							Number Requests</a>
						</li>
						<li class="@if(Request::is('numbers/create')) {{'active open'}} @endif">
							<a href="{{url('numbers/create')}}">
							<i class="icon-plus"></i>
							Add Number</a>
						</li>
						@endif
                ...
                <li class="@if(Request::is('users/myaccount')) {{'active open'}} @endif">
					<a href="{{url('users/myaccount')}}">
						...
						<div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
							...
							<ul class="media-list list-items">
								<li class="media">
									...
									<img class="media-object" src="{{ asset('/public/assets/admin/layout/img/avatar3.jpg')}}" alt="...">
								...
								<li class="media">
									<img class="media-object" src="{{ asset('/public/assets/admin/layout/img/avatar1.jpg')}}" alt="...">
									<div class="media-body">
								...
								<li class="media">
									...
									<img class="media-object" src="{{ asset('/public/assets/admin/layout/img/avatar4.jpg')}}" alt="...">
									<div class="media-body">
								...
								<li class="media">
									<img class="media-object" src="{{ asset('/public/assets/admin/layout/img/avatar2.jpg')}}" alt="...">
									<div class="media-body">
							...
							<ul class="media-list list-items">
								<li class="media">
									...
									<img class="media-object" src="{{ asset('/public/assets/admin/layout/img/avatar6.jpg')}}" alt="...">
									<div class="media-body">
								...
								<li class="media">
									...
									<img class="media-object" src="{{ asset('/public/assets/admin/layout/img/avatar7.jpg')}}" alt="...">
									<div class="media-body">
								...
								<li class="media">
									<img class="media-object" src="{{ asset('/public/assets/admin/layout/img/avatar8.jpg')}}" alt="...">
									<div class="media-body">
								...
								<li class="media">
									...
									<img class="media-object" src="{{ asset('/public/assets/admin/layout/img/avatar9.jpg')}}" alt="...">
									<div class="media-body">
								...
								<li class="media">
									<img class="media-object" src="{{ asset('/public/assets/admin/layout/img/avatar10.jpg')}}" alt="...">
									<div class="media-body">
								...
								<li class="media">
									...
									<img class="media-object" src="{{ asset('/public/assets/admin/layout/img/avatar11.jpg')}}" alt="...">
									<div class="media-body">
						...
						<div class="page-quick-sidebar-item">
							<div class="page-quick-sidebar-chat-user">
								...
								<div class="page-quick-sidebar-chat-user-messages">
									<div class="post out">
										<img class="avatar" alt="" src="{{ asset('/public/assets/admin/layout/img/avatar3.jpg')}}"/>
										<div class="message">
											<span class="arrow"></span>
									...
									<div class="post in">
										<img class="avatar" alt="" src="{{ asset('/public/assets/admin/layout/img/avatar2.jpg')}}"/>
										<div class="message">
											<span class="arrow"></span>
